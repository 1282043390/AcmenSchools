        ...
        <dl class="system_log">
            <dt>
                <img class="icon1" src="/admin/img/coin03.png" /><img class="icon2"
                                                                  src="/admin/img/coin04.png" /> 导航栏管理<img class="icon3"
            ...
            <dd>
                <img class="coin11" src="/admin/img/coin111.png" /><img class="coin22"
                                                                    src="/admin/img/coin222.png" /><a class="cks" href="../user.html"
                                                                                                  target="main">导航栏添加</a><img class="icon5" src="/admin/img/coin21.png" />
            </dd>
            <dd>
                <img class="coin11" src="/admin/img/coin111.png" /><img class="coin22"
                                                                        src="/admin/img/coin222.png" /><a class="cks" href="/admin/rests/navigation/list"
                                                                                                          target="main">导航栏展示</a><img class="icon5" src="/admin/img/coin21.png" />
            </dd>
        </dl>
        <dl class="system_log">
            <dt>
                <img class="icon1" src="/admin/img/coin05.png" /><img class="icon2"
                                                                  src="/admin/img/coin06.png" /> 公共管理<img class="icon3"
                                                                                                      src="/admin/img/coin19.png" /><img class="icon4"
                                                                                                                                     src="/admin/img/coin20.png" />
            </dt>
            <dd>
                <img class="coin11" src="/admin/img/coin111.png" /><img class="coin22"
                                                                    src="/admin/img/coin222.png" /><a class="cks" href="../banner.html"
                                                                                                  target="main">广告管理</a><img class="icon5" src="/admin/img/coin21.png" />
            </dd>
            <dd>
                <img class="coin11" src="/admin/img/coin111.png" /><img class="coin22"
                                                                    src="/admin/img/coin222.png" /><a class="cks" href="../opinion.html"
                                                                                                  target="main">意见管理</a><img class="icon5" src="/admin/img/coin21.png" />
            </dd>
        </dl>
        <dl class="system_log">
            <dt>
                <img class="icon1" src="/admin/img/coin07.png" /><img class="icon2"
                                                                  src="/admin/img/coin08.png" /> 会员管理<img class="icon3"
                                                                                                      src="/admin/img/coin19.png" /><img class="icon4"
                                                                                                                                     src="/admin/img/coin20.png" />
            </dt>
            <dd>
                <img class="coin11" src="/admin/img/coin111.png" /><img class="coin22"
                                                                    src="/admin/img/coin222.png" /><a href="../vip.html" target="main"
                                                                                                  class="cks">会员管理</a><img class="icon5" src="/admin/img/coin21.png" />
            </dd>
        </dl>
        <dl class="system_log">
            <dt>
                <img class="icon1" src="/admin/img/coin10.png" /><img class="icon2"
                                                                  src="/admin/img/coin09.png" /> 行家管理<img class="icon3"
                                                                                                      src="/admin/img/coin19.png" /><img class="icon4"
                                                                                                                                     src="/admin/img/coin20.png" />
            </dt>
            <dd>
                <img class="coin11" src="/admin/img/coin111.png" /><img class="coin22"
                                                                    src="/admin/img/coin222.png" /><a href="../connoisseur.html"
        ...
        <dl class="system_log">
            <dt>
                <img class="icon1" src="/admin/img/coin11.png" /><img class="icon2"
                                                                  src="/admin/img/coin12.png" /> 话题管理<img class="icon3"
                                                                                                      src="/admin/img/coin19.png" /><img class="icon4"
                                                                                                                                     src="/admin/img/coin20.png" />
            </dt>
            <dd>
                <img class="coin11" src="/admin/img/coin111.png" /><img class="coin22"
                                                                    src="/admin/img/coin222.png" /><a href="../topic.html" target="main"
                                                                                                  class="cks">话题管理</a><img class="icon5" src="/admin/img/coin21.png" />
            </dd>
        </dl>
        <dl class="system_log">
            <dt>
                <img class="icon1" src="/admin/img/coin14.png" /><img class="icon2"
                                                                  src="/admin/img/coin13.png" /> 心愿管理<img class="icon3"
                                                                                                      src="/admin/img/coin19.png" /><img class="icon4"
                                                                                                                                     src="/admin/img/coin20.png" />
            </dt>
            <dd>
                <img class="coin11" src="/admin/img/coin111.png" /><img class="coin22"
                                                                    src="/admin/img/coin222.png" /><a href="../wish.html" target="main"
                                                                                                  class="cks">心愿管理</a><img class="icon5" src="/admin/img/coin21.png" />
            </dd>
        </dl>
        <dl class="system_log">
            <dt>
